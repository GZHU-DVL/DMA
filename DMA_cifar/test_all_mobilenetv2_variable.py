...
from load_attacked_and_meta_model_mobilenetv2 import load_attacked_model, load_meta_model
...
def main( device):
    ...
    for i, (img, target) in enumerate(test_loader):
        ...
        if success:
            ...
            query_zoograd += query_times_for_zoograd
    ...
    if total_success == 0:
        ...
        print("[STATS][L1] total = {}, seq = {}, time = {:.3f}, success = {}, distortion = {:.5f}, avg_step = {:.5f},query_zoograd = {},avg_query = {:.5f}, new_query = {:.5f},success_rate = {:.3f}".format(img_no, i, avg_time / total_success, success, l2_total / total_success, avg_step / total_success,query_zoograd / total_success,avg_qry / total_success, average_query / total_success,total_success / float(img_no)))
