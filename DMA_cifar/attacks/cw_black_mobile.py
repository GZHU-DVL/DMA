...
every_iter =  args.finetune_interval # every_iter=3
...
class BlackBoxL2:
    ...
    def _optimize(self, model, meta_model, step, input_var, modifier_var, target_var, scale_const_var,
     target, batch_idx, indice,query_times_for_zoograd,stage_ft,j,input_orig=None):
        ...
        # query model for loss 
        # every step costs a query untill successful
        ...
        if  step < 1:
            ...
            query_times_for_zoograd  = query_times_for_zoograd + 1
            ...
            return loss_np, loss1, loss2, dist_np, output_np, input_adv_np,indice,step_query_bias,query_times_for_zoograd,stage_ft,j
    ...
    def run(self, model, meta_model, input, target, batch_idx = 0):
        ...
        for search_step in range(self.binary_search_steps):
            ...
            for step in range(self.max_steps):
                ...
                loss, loss1, loss2, dist, output, adv_img,indice,step_query_bias,query_times_for_zoograd, stage_ft, j= self._optimize(
                    model,
                    meta_model,
                    step,
                    input_var,
        ...
        if first_step>max_iter:
            first_step = max_iter
        return o_best_attack, scale_const, first_step,best_query_bias,query_times_for_zoograd
